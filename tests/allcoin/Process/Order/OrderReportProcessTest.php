...
namespace Test\AllCoin\Process\Order;
...
class OrderReportProcessTest extends TestCase
{
    ...
    public function testHandleShouldBeOK(): void
    {
        ...
        $orderETHBuyAmount = 7.;
        $orderETHBuy->expects($this->exactly(2))->method('getAmount')->willReturn($orderETHBuyAmount);
        ...
        $orderETHBuy->expects($this->once())->method('getQuantity')->willReturn($orderETHBuyQuantity);
        $prices = [$lastPrice];
